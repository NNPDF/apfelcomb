# Run merge
FKmerge FK_TTBARTOT_7TEV.dat FK_TTBARTOT_7TEV.dat FK_TTBARTOT_7TEV.dat FK_TTBARTOT_7TEV.dat FK_TTBARTOT_8TEV.dat FK_TTBARTOT_8TEV.dat > FK_TTBARTOT_UN.dat 
